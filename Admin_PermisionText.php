...
<!-- Page (2 columns) -->
    ...
    <div id="page-in" class="box">
        ...
        <div id="content">
            ...
            <!-- Article -->
            <div class="article">
                <h2><span><a href="#">Thanks For Registration</a></span></h2>
                ...
                <h2><p style="color:#FF0000">Your account will be verified. </p>
				<p>Your account will be given admin permission. Then you can use your account.</p></h2><b><b>
